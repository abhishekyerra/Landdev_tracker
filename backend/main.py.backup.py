...
async def create_budget(
    ...
    db_budget = models.ProjectBudget(**budget.dict(), project_id=project_id)
    db.add(db_budget)
    db.commit()
...
async def get_project_budgets(
    ...
    budgets = db.query(models.ProjectBudget)\
        .filter(models.ProjectBudget.project_id == project_id)\
        .all()
    return budgets
...
async def create_expense(
    ...
    db_expense = models.Expense(**expense.dict(), project_id=project_id)
    db.add(db_expense)
    db.commit()
